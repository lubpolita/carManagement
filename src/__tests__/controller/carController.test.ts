...
describe('Car', () => {
  ...
  afterAll(async () => {
    ...
    it('Should be able to create a new car', async () => {
        ...
        await createCarServiceMock.prototype.execute.mockResolvedValueOnce(new Car(),);
    ...
    expect(response.body).not.toBe(undefined)
      ...
      it('Should be able to get all cars', async () => {
        ...
        await findAllCarServiceMock.prototype.execute.mockResolvedValueOnce([ new Car() ]);
  ...
  it('Should be able to get a car by id', async () => {
    ...
    await findByIdCarServiceMock.prototype.execute.mockResolvedValueOnce(new Car());
