...
describe('Driver', () => {
  ...
  it('Should be able to create a new driver', async () => {
    await createDriverServiceMock.prototype.execute.mockResolvedValueOnce(
      new Driver(),
    );
  ...
  it('Should be able to get all drivers', async () => {
    await findAllDriverServiceMock.prototype.execute.mockResolvedValueOnce([
      new Driver(),
    ]);
  ...
  it('Should be able to get a driver by id', async () => {
    await findByIdDriverServiceMock.prototype.execute.mockResolvedValueOnce(
      new Driver(),
    );
